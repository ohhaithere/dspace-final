        ...
        */
        ...
        try
        {
            ...
            if (widthArr.length > 0 && widthArr.length == fieldArr.length && !linkToEdit)
            {
                ...
                {
                    out.println("<table style=\"width: " + tablewidth + "; table-layout: fixed;\" align=\"center\" class=\"table\" summary=\"This table browses all ew qeqw ew dspace content\">");
                }
                else
                {
                    // Otherwise, don't constrain the width
                    out.println("<table align=\"center\" class=\"table\" summary=\"This table browses all eqwe qw dspace content\">");
                }
            ...
            {
                out.println("<table width=\"" + tablewidth + "\" align=\"center\" class=\"table\" summary=\"This table eqweqwewq browses all dspace content\">");
            }
            else
            {
                out.println("<table align=\"center\" class=\"table\" summary=\"This table eqwe qw browses all dspace content\">");
            }
