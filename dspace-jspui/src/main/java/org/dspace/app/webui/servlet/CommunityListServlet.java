    ...
    { 
           synchronized (staticLock) 
           {
            ...
            request.setAttribute("subcommunities.map", commMap);
               ...
               request.setAttribute("metaTag", "учебные материалы сгау, методические материалы сгау, монографии сгау, авторефераты сгау, диссертации сгау, ученые сгау");
               request.setAttribute("descrTag", "В репозитории СГАУ (ныне – Самарский университет) ресурсы вынесены в три основных раздела библиотеки – Учебные материалы, Монографии, Авторефераты и диссертации. Первый из них содержит коллекции методических указаний и учебных пособий. Второй – труды ведущих ученых Самарского национального исследовательского университета. Авторефераты и диссертации в третьем разделе вынесены в две отдельные коллекции.");
