...
<dspace:layout navbar="admin"  style="submission" titlekey="jsp.register.edit-profile.title" nocache="true">
   Коллекций просмотрено: <%= colVisits %><br>
   Разделов просмотрено: <%= comVisits %><br>
   Количество аутентификаций пользователей: <%= userLogins %><br>
   Ресурсов всего: <%= itemsOverall %><br>
   Ресурсов просмотрено: <%= itemVisits %><br>
