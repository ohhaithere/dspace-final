...
<% } %>
<% if(i == 5){ %>
<a href="<%= request.getContextPath() %>/reports?dateStart=2016-09-01&dateEnd=2016-09-30">Сентябрь 2016</a> 
<% } %>
<% if(i == 6){ %>
<a href="<%= request.getContextPath() %>/reports?dateStart=2016-10-01&dateEnd=2016-10-30">Октябрь 2016</a> 
<% } %>
<% if(i == 7){ %>
<a href="<%= request.getContextPath() %>/reports?dateStart=2016-11-01&dateEnd=2016-11-30">Ноябрь 2016</a> 
<% } %>
<% if(i == 8){ %>
<a href="<%= request.getContextPath() %>/reports?dateStart=2016-12-01&dateEnd=2016-12-30">Декабрь 2016</a> 
<% } %>
<% if(i != months - 1){ %>
- 
<% } %>
...
<div align="center"><b>Отчет за все время</b></div>
    ...
    <br>
<% } %>
<form action="<%= request.getContextPath() %>/reports" method="post" name="edit_metadata" id="edit_metadata" onkeydown="return disableEnterKey(event);">
<table>
  <tr><td>
