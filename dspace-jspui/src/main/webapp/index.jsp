...
<%
    ...
    try
    {
        ...
        // Show home page JSP
        request.setAttribute("metaTag", "сгау, самарский государственный аэрокосмический университет, книги, документы, библиотека, монографии, справочники, статьи, диссертации, авторефераты, учебники, электронный каталог, репозиторий, dspace, самарский университет, самарский национально  исследовательский университет");
        request.setAttribute("descrTag", "В репозитории Самарского университета (ранее СГАУ) представлен широкий перечень монографий, диссертаций, материалов периодических изданий, аудио и видео-контента.  В  электронном каталоге хранятся научные труды ведущих ученых Самарского национального исследовательского университета, таких как В.А. Сойфер, В.А. Зрелов, В.С. Кузьмичев и другие.");
        request.setAttribute("h1", "Репозиторий Самарского национального исследовательского университета имени академика С.П. Королёва");
